...
function tampilkanStatusJawaban(data) {
    ...
    const soalDiabaikan = ['Info Kelompok', 'nama-siswa', 'Link Presentasi', 'Alasan Kesimpulan', 'KOMENTAR_KEL_1', 'KOMENTAR_KEL_2', 'KOMENTAR_KEL_3', 'KOMENTAR_KEL_4', 'KOMENTAR_KEL_5', 'KOMENTAR_KEL_6', 'KOMENTAR_KEL_7', 'KOMENTAR_KEL_8'];
